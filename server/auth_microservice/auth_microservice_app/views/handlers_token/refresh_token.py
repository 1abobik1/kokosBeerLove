...
@swagger_auto_schema(
    ...
    responses={
        200: openapi.Response(
            description="Новый access токен", examples={"application/json": {"access": "новый access токен"}}
        ),
...
def refresh_token(request):
    ...
    try:
        ...
        try:
            ...
            return Response(
                {"error": "Refresh токен не найден в базе данных"}, status=status.HTTP_401_UNAUTHORIZED
            )
