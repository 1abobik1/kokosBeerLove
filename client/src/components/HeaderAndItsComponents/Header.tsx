            ...
            <Toolbar sx={{flexDirection: 'column', alignItems: 'center', paddingBottom: '20px'}}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <MenuItem style={{fontWeight: 'bold'}} component={Link} to="/news">
                                Новости
                            </MenuItem>
                            <MenuItem style={{fontWeight: 'bold'}} component={Link} to="/matches">
                                Матчи
                            </MenuItem>
                            <MenuItem style={{fontWeight: 'bold'}} component={Link} to="/team">
                                Команда
                            </MenuItem>
                            <MenuItem style={{fontWeight: 'bold'}} component={Link} to="/about">
                                О клубе
                            </MenuItem>
                            <MenuItem style={{fontWeight: 'bold'}} component={Link} to="/shop">
                                Магазин
                            </MenuItem>
                            <MenuItem
